...
| `system_prompt_injection` field | Live |
| Contradiction detection | Live |
| Correction audit trail | Live |
| `constraints` object in export | Live |
| `POST /v1/context/constrain` — set constraints | In progress |
| Constraint enforcement (server-side) | In progress |
| Point-in-time reconstruction | In testing |
